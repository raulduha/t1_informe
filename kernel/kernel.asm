...
kernel/kernel:     formato del fichero elf32-i386
...
80100028:	bc e0 5e 11 80       	mov    $0x80115ee0,%esp
...
801003b0:	e8 cb 02 00 00       	call   80100680 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 5b 7e 10 80 	movl   $0x80107e5b,(%esp)
...
80100535:	68 45 75 10 80       	push   $0x80107545
...
8010058d:	e8 ae 58 00 00       	call   80105e40 <uartputc>
  cgaputc(c);
...
80100606:	0f b6 92 70 75 10 80 	movzbl -0x7fef8a90(%edx),%edx
  }while((x /= base) != 0);
...
80100647:	e8 f4 57 00 00       	call   80105e40 <uartputc>
  cgaputc(c);
...
8010072f:	0f 85 33 01 00 00    	jne    80100868 <cprintf+0x1e8>
        s = "(null)";
80100735:	bf 58 75 10 80       	mov    $0x80107558,%edi
      for(; *s; s++)
...
801007aa:	e8 91 56 00 00       	call   80105e40 <uartputc>
  cgaputc(c);
...
801007f7:	e8 44 56 00 00       	call   80105e40 <uartputc>
  cgaputc(c);
...
80100838:	e8 03 56 00 00       	call   80105e40 <uartputc>
  cgaputc(c);
...
80100883:	e8 b8 55 00 00       	call   80105e40 <uartputc>
  cgaputc(c);
...
801008af:	e8 8c 55 00 00       	call   80105e40 <uartputc>
  cgaputc(c);
...
801008e6:	68 5f 75 10 80       	push   $0x8010755f
...
80100993:	e8 a8 54 00 00       	call   80105e40 <uartputc>
80100998:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010099f:	e8 9c 54 00 00       	call   80105e40 <uartputc>
801009a4:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801009ab:	e8 90 54 00 00       	call   80105e40 <uartputc>
  cgaputc(c);
...
80100a5d:	e8 de 53 00 00       	call   80105e40 <uartputc>
80100a62:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100a69:	e8 d2 53 00 00       	call   80105e40 <uartputc>
80100a6e:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100a75:	e8 c6 53 00 00       	call   80105e40 <uartputc>
  cgaputc(c);
...
80100ad5:	e8 66 53 00 00       	call   80105e40 <uartputc>
80100ada:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100ae1:	e8 5a 53 00 00       	call   80105e40 <uartputc>
80100ae6:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100aed:	e8 4e 53 00 00       	call   80105e40 <uartputc>
  cgaputc(c);
...
80100b25:	e8 16 53 00 00       	call   80105e40 <uartputc>
  cgaputc(c);
...
80100b48:	e8 f3 52 00 00       	call   80105e40 <uartputc>
  cgaputc(c);
...
80100b86:	68 68 75 10 80       	push   $0x80107568
...
80100c52:	75 d2                	jne    80100c26 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100c54:	e8 77 63 00 00       	call   80106fd0 <setupkvm>
...
80100cc3:	e8 28 61 00 00       	call   80106df0 <allocuvm>
...
80100cf9:	e8 02 60 00 00       	call   80106d00 <loaduvm>
...
80100d3b:	e8 10 62 00 00       	call   80106f50 <freevm>
  if(ip){
...
80100d82:	e8 69 60 00 00       	call   80106df0 <allocuvm>
...
80100da1:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100da3:	e8 c8 62 00 00       	call   80107070 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100e31:	e8 1a 61 00 00       	call   80106f50 <freevm>
...
80100eed:	e8 7e 5c 00 00       	call   80106b70 <switchuvm>
  freevm(oldpgdir);
80100ef2:	89 3c 24             	mov    %edi,(%esp)
80100ef5:	e8 56 60 00 00       	call   80106f50 <freevm>
  return 0;
...
80100f0c:	68 81 75 10 80       	push   $0x80107581
...
80100f36:	68 8d 75 10 80       	push   $0x8010758d
...
80100ffb:	68 94 75 10 80       	push   $0x80107594
...
801010dc:	68 9c 75 10 80       	push   $0x8010759c
...
801011c2:	68 a6 75 10 80       	push   $0x801075a6
...
8010129b:	68 af 75 10 80       	push   $0x801075af
...
801012d1:	68 b5 75 10 80       	push   $0x801075b5
...
80101347:	68 bf 75 10 80       	push   $0x801075bf
...
80101404:	68 d2 75 10 80       	push   $0x801075d2
...
80101552:	68 e8 75 10 80       	push   $0x801075e8
...
80101625:	68 f8 75 10 80       	push   $0x801075f8
...
8010167c:	68 0b 76 10 80       	push   $0x8010760b
...
80101693:	68 12 76 10 80       	push   $0x80107612
...
80101703:	68 78 76 10 80       	push   $0x80107678
...
801017d3:	68 18 76 10 80       	push   $0x80107618
...
8010194d:	68 30 76 10 80       	push   $0x80107630
80101952:	e8 29 ea ff ff       	call   80100380 <panic>
    panic("ilock");
80101957:	83 ec 0c             	sub    $0xc,%esp
8010195a:	68 2a 76 10 80       	push   $0x8010762a
...
801019a7:	68 3f 76 10 80       	push   $0x8010763f
...
80101b63:	68 3f 76 10 80       	push   $0x8010763f
...
80101e82:	68 59 76 10 80       	push   $0x80107659
80101e87:	e8 f4 e4 ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
80101e8c:	83 ec 0c             	sub    $0xc,%esp
80101e8f:	68 47 76 10 80       	push   $0x80107647
...
801020df:	68 3f 76 10 80       	push   $0x8010763f
...
8010218b:	68 68 76 10 80       	push   $0x80107668
80102190:	e8 eb e1 ff ff       	call   80100380 <panic>
    panic("dirlink");
80102195:	83 ec 0c             	sub    $0xc,%esp
80102198:	68 42 7c 10 80       	push   $0x80107c42
...
801022ab:	68 d4 76 10 80       	push   $0x801076d4
801022b0:	e8 cb e0 ff ff       	call   80100380 <panic>
    panic("idestart");
801022b5:	83 ec 0c             	sub    $0xc,%esp
801022b8:	68 cb 76 10 80       	push   $0x801076cb
...
801022d6:	68 e6 76 10 80       	push   $0x801076e6
...
8010252a:	68 34 77 10 80       	push   $0x80107734
...
801025e2:	81 fb e0 5e 11 80    	cmp    $0x80115ee0,%ebx
...
8010265b:	68 66 77 10 80       	push   $0x80107766
...
8010272b:	68 6c 77 10 80       	push   $0x8010776c
...
8010283b:	0f b6 91 a0 78 10 80 	movzbl -0x7fef8760(%ecx),%edx
  shift ^= togglecode[data];
80102842:	0f b6 81 a0 77 10 80 	movzbl -0x7fef8860(%ecx),%eax
  shift |= shiftcode[data];
...
80102858:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010285b:	8b 04 85 80 77 10 80 	mov    -0x7fef8880(,%eax,4),%eax
...
80102898:	31 c0                	xor    %eax,%eax
    shift &= ~(shiftcode[data] | E0ESC);
8010289a:	0f b6 91 a0 78 10 80 	movzbl -0x7fef8760(%ecx),%edx
...
80102dda:	68 a0 79 10 80       	push   $0x801079a0
...
80103037:	68 a4 79 10 80       	push   $0x801079a4
...
801030f1:	68 b3 79 10 80       	push   $0x801079b3
801030f6:	e8 85 d2 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
801030fb:	83 ec 0c             	sub    $0xc,%esp
801030fe:	68 c9 79 10 80       	push   $0x801079c9
...
80103128:	68 e4 79 10 80       	push   $0x801079e4
8010312d:	e8 4e d5 ff ff       	call   80100680 <cprintf>
  idtinit();       // load idt register
80103132:	e8 19 29 00 00       	call   80105a50 <idtinit>
...
80103153:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103156:	e8 05 3a 00 00       	call   80106b60 <switchkvm>
  seginit();
8010315b:	e8 70 39 00 00       	call   80106ad0 <seginit>
  lapicinit();
...
801031b4:	e8 87 2b 00 00       	call   80105d40 <uartinit>
  pinit();         // process table
801031b9:	e8 22 08 00 00       	call   801039e0 <pinit>
  tvinit();        // trap vectors
801031be:	e8 0d 28 00 00       	call   801059d0 <tvinit>
  binit();         // buffer cache
...
801031da:	68 90 a4 10 80       	push   $0x8010a490
...
801032ce:	68 f8 79 10 80       	push   $0x801079f8
...
80103386:	68 fd 79 10 80       	push   $0x801079fd
...
801034a3:	68 02 7a 10 80       	push   $0x80107a02
...
801034d2:	68 f8 79 10 80       	push   $0x801079f8
...
80103508:	68 1c 7a 10 80       	push   $0x80107a1c
...
801035b0:	00 00 00 
  initlock(&p->lock, "pipe");
801035b3:	68 3b 7a 10 80       	push   $0x80107a3b
...
80103934:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103937:	c7 40 14 c2 59 10 80 	movl   $0x801059c2,0x14(%eax)
  p->context = (struct context*)sp;
...
801039e6:	68 40 7a 10 80       	push   $0x80107a40
...
80103ad3:	e8 f8 34 00 00       	call   80106fd0 <setupkvm>
...
80103aeb:	68 64 a4 10 80       	push   $0x8010a464
80103af0:	50                   	push   %eax
80103af1:	e8 8a 31 00 00       	call   80106c80 <inituvm>
...
80103b5f:	68 70 7a 10 80       	push   $0x80107a70
80103b64:	50                   	push   %eax
80103b65:	e8 d6 0d 00 00       	call   80104940 <safestrcpy>
  p->cwd = namei("/");
80103b6a:	c7 04 24 79 7a 10 80 	movl   $0x80107a79,(%esp)
...
80103ba3:	68 57 7a 10 80       	push   $0x80107a57
...
80103bdb:	e8 90 2f 00 00       	call   80106b70 <switchuvm>
  return 0;
...
80103bfa:	e8 f1 31 00 00       	call   80106df0 <allocuvm>
...
80103c1a:	e8 01 33 00 00       	call   80106f20 <deallocuvm>
...
80103c68:	e8 53 34 00 00       	call   801070c0 <copyuvm>
...
80103da0:	e8 cb 2d 00 00       	call   80106b70 <switchuvm>
...
80103db2:	e8 e4 0b 00 00       	call   8010499b <swtch>
      switchkvm();
80103db7:	e8 a4 2d 00 00       	call   80106b60 <switchkvm>
      c->proc = 0;
...
80103fbd:	68 c8 7a 10 80       	push   $0x80107ac8
80103fc2:	e8 b9 c3 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103fc7:	83 ec 0c             	sub    $0xc,%esp
80103fca:	68 bb 7a 10 80       	push   $0x80107abb
...
801040a9:	e8 a2 2e 00 00       	call   80106f50 <freevm>
        p->pid = 0;
...
80104100:	68 d4 7a 10 80       	push   $0x80107ad4
...
80104209:	68 da 7a 10 80       	push   $0x80107ada
8010420e:	e8 6d c1 ff ff       	call   80100380 <panic>
    panic("sleep");
80104213:	83 ec 0c             	sub    $0xc,%esp
80104216:	68 d4 7a 10 80       	push   $0x80107ad4
...
8010431b:	68 5b 7e 10 80       	push   $0x80107e5b
...
8010433c:	74 ea                	je     80104328 <procdump+0x28>
      state = "???";
8010433e:	ba eb 7a 10 80       	mov    $0x80107aeb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104343:	83 f8 05             	cmp    $0x5,%eax
80104346:	77 11                	ja     80104359 <procdump+0x59>
80104348:	8b 14 85 4c 7b 10 80 	mov    -0x7fef84b4(,%eax,4),%edx
      state = "???";
8010434f:	b8 eb 7a 10 80       	mov    $0x80107aeb,%eax
...
8010435e:	68 ef 7a 10 80       	push   $0x80107aef
...
8010439d:	68 41 75 10 80       	push   $0x80107541
...
801043ca:	68 64 7b 10 80       	push   $0x80107b64
...
80104605:	68 6f 7b 10 80       	push   $0x80107b6f
8010460a:	e8 71 bd ff ff       	call   80100380 <panic>
    panic("popcli");
8010460f:	83 ec 0c             	sub    $0xc,%esp
80104612:	68 86 7b 10 80       	push   $0x80107b86
...
8010467b:	68 8d 7b 10 80       	push   $0x80107b8d
...
80104770:	68 95 7b 10 80       	push   $0x80107b95
...
80104b9c:	8b 14 85 c0 7b 10 80 	mov    -0x7fef8440(,%eax,4),%edx
...
80104bc8:	68 9d 7b 10 80       	push   $0x80107b9d
...
80104d24:	68 38 7c 10 80       	push   $0x80107c38
...
80104d3c:	68 37 7c 10 80       	push   $0x80107c37
...
80104d51:	68 2b 7c 10 80       	push   $0x80107c2b
...
80104d6f:	68 3a 7c 10 80       	push   $0x80107c3a
80104d74:	e8 07 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d79:	83 ec 0c             	sub    $0xc,%esp
80104d7c:	68 1c 7c 10 80       	push   $0x80107c1c
...
80104e18:	83 ec 1c             	sub    $0x1c,%esp
  acquire(&read_count_lock); //agarrar el lock
80104e1b:	68 60 3c 11 80       	push   $0x80113c60
80104e20:	e8 9b f8 ff ff       	call   801046c0 <acquire>
  release(&read_count_lock); //libera el lock
80104e25:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
  read_count++;
80104e2c:	83 05 94 3c 11 80 01 	addl   $0x1,0x80113c94
  release(&read_count_lock); //libera el lock
80104e33:	e8 28 f8 ff ff       	call   80104660 <release>
  if(argint(n, &fd) < 0)
80104e38:	58                   	pop    %eax
80104e39:	5a                   	pop    %edx
...
80104e47:	78 5f                	js     80104ea8 <sys_read+0x98>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104e49:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104e4d:	77 59                	ja     80104ea8 <sys_read+0x98>
80104e4f:	e8 3c ec ff ff       	call   80103a90 <myproc>
80104e54:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104e57:	8b 74 90 28          	mov    0x28(%eax,%edx,4),%esi
80104e5b:	85 f6                	test   %esi,%esi
80104e5d:	74 49                	je     80104ea8 <sys_read+0x98>
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104e5f:	83 ec 08             	sub    $0x8,%esp
80104e62:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104e65:	50                   	push   %eax
80104e66:	6a 02                	push   $0x2
80104e68:	e8 d3 fb ff ff       	call   80104a40 <argint>
80104e6d:	83 c4 10             	add    $0x10,%esp
80104e70:	85 c0                	test   %eax,%eax
80104e72:	78 34                	js     80104ea8 <sys_read+0x98>
80104e74:	83 ec 04             	sub    $0x4,%esp
80104e77:	ff 75 f0             	pushl  -0x10(%ebp)
80104e7a:	53                   	push   %ebx
80104e7b:	6a 01                	push   $0x1
80104e7d:	e8 0e fc ff ff       	call   80104a90 <argptr>
80104e82:	83 c4 10             	add    $0x10,%esp
80104e85:	85 c0                	test   %eax,%eax
80104e87:	78 1f                	js     80104ea8 <sys_read+0x98>
  return fileread(f, p, n);
80104e89:	83 ec 04             	sub    $0x4,%esp
80104e8c:	ff 75 f0             	pushl  -0x10(%ebp)
80104e8f:	ff 75 f4             	pushl  -0xc(%ebp)
80104e92:	56                   	push   %esi
80104e93:	e8 a8 c2 ff ff       	call   80101140 <fileread>
...
80104ead:	eb ec                	jmp    80104e9b <sys_read+0x8b>
80104eaf:	90                   	nop
...
8010519d:	58                   	pop    %eax
8010519e:	5a                   	pop    %edx
8010519f:	68 38 7c 10 80       	push   $0x80107c38
...
801051b8:	68 37 7c 10 80       	push   $0x80107c37
...
801058c0:	68 c0 3c 11 80       	push   $0x80113cc0
801058c5:	e8 f6 ed ff ff       	call   801046c0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801058ca:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801058cd:	8b 1d a0 3c 11 80    	mov    0x80113ca0,%ebx
  while(ticks - ticks0 < n){
...
801058e3:	68 c0 3c 11 80       	push   $0x80113cc0
801058e8:	68 a0 3c 11 80       	push   $0x80113ca0
801058ed:	e8 6e e8 ff ff       	call   80104160 <sleep>
  while(ticks - ticks0 < n){
801058f2:	a1 a0 3c 11 80       	mov    0x80113ca0,%eax
...
80105910:	68 c0 3c 11 80       	push   $0x80113cc0
...
80105933:	68 c0 3c 11 80       	push   $0x80113cc0
...
80105954:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105957:	68 c0 3c 11 80       	push   $0x80113cc0
8010595c:	e8 5f ed ff ff       	call   801046c0 <acquire>
  xticks = ticks;
80105961:	8b 1d a0 3c 11 80    	mov    0x80113ca0,%ebx
  release(&tickslock);
80105967:	c7 04 24 c0 3c 11 80 	movl   $0x80113cc0,(%esp)
...
80105987:	68 60 3c 11 80       	push   $0x80113c60
8010598c:	e8 2f ed ff ff       	call   801046c0 <acquire>
  count = read_count;
80105991:	8b 1d 94 3c 11 80    	mov    0x80113c94,%ebx
  release(&read_count_lock);
80105997:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
8010599e:	e8 bd ec ff ff       	call   80104660 <release>
...
80105a1e:	00 00 ef 
  initlock(&tickslock, "time");
80105a21:	68 7d 7c 10 80       	push   $0x80107c7d
...
80105aa4:	ff 24 85 24 7d 10 80 	jmp    *-0x7fef82dc(,%eax,4)
...
80105aaf:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105ab0:	e8 9b c8 ff ff       	call   80102350 <ideintr>
    lapiceoi();
80105ab5:	e8 66 cf ff ff       	call   80102a20 <lapiceoi>
  }
...
80105b77:	ff 75 e4             	pushl  -0x1c(%ebp)
...
80105b85:	68 e0 7c 10 80       	push   $0x80107ce0
...
80105bd7:	68 88 7c 10 80       	push   $0x80107c88
80105bdc:	e8 9f aa ff ff       	call   80100680 <cprintf>
    lapiceoi();
80105be1:	e8 3a ce ff ff       	call   80102a20 <lapiceoi>
    break;
...
80105c40:	e8 5b 02 00 00       	call   80105ea0 <uartintr>
    lapiceoi();
80105c45:	e8 d6 cd ff ff       	call   80102a20 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105c5c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105c60:	e8 7b cc ff ff       	call   801028e0 <kbdintr>
    lapiceoi();
80105c65:	e8 b6 cd ff ff       	call   80102a20 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105cf0:	ff 73 30             	pushl  0x30(%ebx)
80105cf3:	68 ac 7c 10 80       	push   $0x80107cac
80105cf8:	e8 83 a9 ff ff       	call   80100680 <cprintf>
      panic("trap");
80105cfd:	83 c4 14             	add    $0x14,%esp
80105d00:	68 82 7c 10 80       	push   $0x80107c82
...
80105d97:	0f 84 93 00 00 00    	je     80105e30 <uartinit+0xf0>
  uart = 1;
80105d9d:	c7 05 00 45 11 80 01 	movl   $0x1,0x80114500
80105da4:	00 00 00 
...
80105db0:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105db3:	bf a4 7d 10 80       	mov    $0x80107da4,%edi
80105db8:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105dbd:	6a 00                	push   $0x0
80105dbf:	6a 04                	push   $0x4
80105dc1:	e8 ca c7 ff ff       	call   80102590 <ioapicenable>
80105dc6:	c6 45 e7 76          	movb   $0x76,-0x19(%ebp)
80105dca:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105dcd:	c6 45 e6 78          	movb   $0x78,-0x1a(%ebp)
80105dd1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105dd8:	a1 00 45 11 80       	mov    0x80114500,%eax
80105ddd:	bb 80 00 00 00       	mov    $0x80,%ebx
80105de2:	85 c0                	test   %eax,%eax
80105de4:	75 1c                	jne    80105e02 <uartinit+0xc2>
80105de6:	eb 2b                	jmp    80105e13 <uartinit+0xd3>
80105de8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105def:	90                   	nop
    microdelay(10);
80105df0:	83 ec 0c             	sub    $0xc,%esp
80105df3:	6a 0a                	push   $0xa
80105df5:	e8 46 cc ff ff       	call   80102a40 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105dfa:	83 c4 10             	add    $0x10,%esp
80105dfd:	83 eb 01             	sub    $0x1,%ebx
80105e00:	74 07                	je     80105e09 <uartinit+0xc9>
80105e02:	89 f2                	mov    %esi,%edx
80105e04:	ec                   	in     (%dx),%al
80105e05:	a8 20                	test   $0x20,%al
80105e07:	74 e7                	je     80105df0 <uartinit+0xb0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105e09:	0f b6 45 e6          	movzbl -0x1a(%ebp),%eax
80105e0d:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105e12:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80105e13:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105e17:	83 c7 01             	add    $0x1,%edi
80105e1a:	84 c0                	test   %al,%al
80105e1c:	74 12                	je     80105e30 <uartinit+0xf0>
80105e1e:	88 45 e6             	mov    %al,-0x1a(%ebp)
80105e21:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80105e25:	88 45 e7             	mov    %al,-0x19(%ebp)
80105e28:	eb ae                	jmp    80105dd8 <uartinit+0x98>
...
80105e40 <uartputc>:
  if(!uart)
80105e40:	a1 00 45 11 80       	mov    0x80114500,%eax
...
80105e65:	e8 d6 cb ff ff       	call   80102a40 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
...
80105ea6:	68 10 5d 10 80       	push   $0x80105d10
80105eab:	e8 40 aa ff ff       	call   801008f0 <consoleintr>
}
...
80105eb7:	6a 00                	push   $0x0
  jmp alltraps
80105eb9:	e9 ec fa ff ff       	jmp    801059aa <alltraps>
...
80105ec0:	6a 01                	push   $0x1
  jmp alltraps
80105ec2:	e9 e3 fa ff ff       	jmp    801059aa <alltraps>
...
80105ec9:	6a 02                	push   $0x2
  jmp alltraps
80105ecb:	e9 da fa ff ff       	jmp    801059aa <alltraps>
...
80105ed2:	6a 03                	push   $0x3
  jmp alltraps
80105ed4:	e9 d1 fa ff ff       	jmp    801059aa <alltraps>
...
80105edb:	6a 04                	push   $0x4
  jmp alltraps
80105edd:	e9 c8 fa ff ff       	jmp    801059aa <alltraps>
...
80105ee4:	6a 05                	push   $0x5
  jmp alltraps
80105ee6:	e9 bf fa ff ff       	jmp    801059aa <alltraps>
...
80105eed:	6a 06                	push   $0x6
  jmp alltraps
80105eef:	e9 b6 fa ff ff       	jmp    801059aa <alltraps>
...
80105ef6:	6a 07                	push   $0x7
  jmp alltraps
80105ef8:	e9 ad fa ff ff       	jmp    801059aa <alltraps>
...
80105efd:	6a 08                	push   $0x8
  jmp alltraps
80105eff:	e9 a6 fa ff ff       	jmp    801059aa <alltraps>
...
80105f06:	6a 09                	push   $0x9
  jmp alltraps
80105f08:	e9 9d fa ff ff       	jmp    801059aa <alltraps>
...
80105f0d:	6a 0a                	push   $0xa
  jmp alltraps
80105f0f:	e9 96 fa ff ff       	jmp    801059aa <alltraps>
...
80105f14:	6a 0b                	push   $0xb
  jmp alltraps
80105f16:	e9 8f fa ff ff       	jmp    801059aa <alltraps>
...
80105f1b:	6a 0c                	push   $0xc
  jmp alltraps
80105f1d:	e9 88 fa ff ff       	jmp    801059aa <alltraps>
...
80105f22:	6a 0d                	push   $0xd
  jmp alltraps
80105f24:	e9 81 fa ff ff       	jmp    801059aa <alltraps>
...
80105f29:	6a 0e                	push   $0xe
  jmp alltraps
80105f2b:	e9 7a fa ff ff       	jmp    801059aa <alltraps>
...
80105f32:	6a 0f                	push   $0xf
  jmp alltraps
80105f34:	e9 71 fa ff ff       	jmp    801059aa <alltraps>
...
80105f3b:	6a 10                	push   $0x10
  jmp alltraps
80105f3d:	e9 68 fa ff ff       	jmp    801059aa <alltraps>
...
80105f42:	6a 11                	push   $0x11
  jmp alltraps
80105f44:	e9 61 fa ff ff       	jmp    801059aa <alltraps>
...
80105f4b:	6a 12                	push   $0x12
  jmp alltraps
80105f4d:	e9 58 fa ff ff       	jmp    801059aa <alltraps>
...
80105f54:	6a 13                	push   $0x13
  jmp alltraps
80105f56:	e9 4f fa ff ff       	jmp    801059aa <alltraps>
...
80105f5d:	6a 14                	push   $0x14
  jmp alltraps
80105f5f:	e9 46 fa ff ff       	jmp    801059aa <alltraps>
...
80105f66:	6a 15                	push   $0x15
  jmp alltraps
80105f68:	e9 3d fa ff ff       	jmp    801059aa <alltraps>
...
80105f6f:	6a 16                	push   $0x16
  jmp alltraps
80105f71:	e9 34 fa ff ff       	jmp    801059aa <alltraps>
...
80105f78:	6a 17                	push   $0x17
  jmp alltraps
80105f7a:	e9 2b fa ff ff       	jmp    801059aa <alltraps>
...
80105f81:	6a 18                	push   $0x18
  jmp alltraps
80105f83:	e9 22 fa ff ff       	jmp    801059aa <alltraps>
...
80105f8a:	6a 19                	push   $0x19
  jmp alltraps
80105f8c:	e9 19 fa ff ff       	jmp    801059aa <alltraps>
...
80105f93:	6a 1a                	push   $0x1a
  jmp alltraps
80105f95:	e9 10 fa ff ff       	jmp    801059aa <alltraps>
...
80105f9c:	6a 1b                	push   $0x1b
  jmp alltraps
80105f9e:	e9 07 fa ff ff       	jmp    801059aa <alltraps>
...
80105fa5:	6a 1c                	push   $0x1c
  jmp alltraps
80105fa7:	e9 fe f9 ff ff       	jmp    801059aa <alltraps>
...
80105fae:	6a 1d                	push   $0x1d
  jmp alltraps
80105fb0:	e9 f5 f9 ff ff       	jmp    801059aa <alltraps>
...
80105fb7:	6a 1e                	push   $0x1e
  jmp alltraps
80105fb9:	e9 ec f9 ff ff       	jmp    801059aa <alltraps>
...
80105fc0:	6a 1f                	push   $0x1f
  jmp alltraps
80105fc2:	e9 e3 f9 ff ff       	jmp    801059aa <alltraps>
...
80105fc9:	6a 20                	push   $0x20
  jmp alltraps
80105fcb:	e9 da f9 ff ff       	jmp    801059aa <alltraps>
...
80105fd2:	6a 21                	push   $0x21
  jmp alltraps
80105fd4:	e9 d1 f9 ff ff       	jmp    801059aa <alltraps>
...
80105fdb:	6a 22                	push   $0x22
  jmp alltraps
80105fdd:	e9 c8 f9 ff ff       	jmp    801059aa <alltraps>
...
80105fe4:	6a 23                	push   $0x23
  jmp alltraps
80105fe6:	e9 bf f9 ff ff       	jmp    801059aa <alltraps>
...
80105fed:	6a 24                	push   $0x24
  jmp alltraps
80105fef:	e9 b6 f9 ff ff       	jmp    801059aa <alltraps>
...
80105ff6:	6a 25                	push   $0x25
  jmp alltraps
80105ff8:	e9 ad f9 ff ff       	jmp    801059aa <alltraps>
...
80105fff:	6a 26                	push   $0x26
  jmp alltraps
80106001:	e9 a4 f9 ff ff       	jmp    801059aa <alltraps>
...
80106008:	6a 27                	push   $0x27
  jmp alltraps
8010600a:	e9 9b f9 ff ff       	jmp    801059aa <alltraps>
...
80106011:	6a 28                	push   $0x28
  jmp alltraps
80106013:	e9 92 f9 ff ff       	jmp    801059aa <alltraps>
...
8010601a:	6a 29                	push   $0x29
  jmp alltraps
8010601c:	e9 89 f9 ff ff       	jmp    801059aa <alltraps>
...
80106023:	6a 2a                	push   $0x2a
  jmp alltraps
80106025:	e9 80 f9 ff ff       	jmp    801059aa <alltraps>
...
8010602c:	6a 2b                	push   $0x2b
  jmp alltraps
8010602e:	e9 77 f9 ff ff       	jmp    801059aa <alltraps>
...
80106035:	6a 2c                	push   $0x2c
  jmp alltraps
80106037:	e9 6e f9 ff ff       	jmp    801059aa <alltraps>
...
8010603e:	6a 2d                	push   $0x2d
  jmp alltraps
80106040:	e9 65 f9 ff ff       	jmp    801059aa <alltraps>
...
80106047:	6a 2e                	push   $0x2e
  jmp alltraps
80106049:	e9 5c f9 ff ff       	jmp    801059aa <alltraps>
...
80106050:	6a 2f                	push   $0x2f
  jmp alltraps
80106052:	e9 53 f9 ff ff       	jmp    801059aa <alltraps>
...
80106059:	6a 30                	push   $0x30
  jmp alltraps
8010605b:	e9 4a f9 ff ff       	jmp    801059aa <alltraps>
...
80106062:	6a 31                	push   $0x31
  jmp alltraps
80106064:	e9 41 f9 ff ff       	jmp    801059aa <alltraps>
...
8010606b:	6a 32                	push   $0x32
  jmp alltraps
8010606d:	e9 38 f9 ff ff       	jmp    801059aa <alltraps>
...
80106074:	6a 33                	push   $0x33
  jmp alltraps
80106076:	e9 2f f9 ff ff       	jmp    801059aa <alltraps>
...
8010607d:	6a 34                	push   $0x34
  jmp alltraps
8010607f:	e9 26 f9 ff ff       	jmp    801059aa <alltraps>
...
80106086:	6a 35                	push   $0x35
  jmp alltraps
80106088:	e9 1d f9 ff ff       	jmp    801059aa <alltraps>
...
8010608f:	6a 36                	push   $0x36
  jmp alltraps
80106091:	e9 14 f9 ff ff       	jmp    801059aa <alltraps>
...
80106098:	6a 37                	push   $0x37
  jmp alltraps
8010609a:	e9 0b f9 ff ff       	jmp    801059aa <alltraps>
...
801060a1:	6a 38                	push   $0x38
  jmp alltraps
801060a3:	e9 02 f9 ff ff       	jmp    801059aa <alltraps>
...
801060aa:	6a 39                	push   $0x39
  jmp alltraps
801060ac:	e9 f9 f8 ff ff       	jmp    801059aa <alltraps>
...
801060b3:	6a 3a                	push   $0x3a
  jmp alltraps
801060b5:	e9 f0 f8 ff ff       	jmp    801059aa <alltraps>
...
801060bc:	6a 3b                	push   $0x3b
  jmp alltraps
801060be:	e9 e7 f8 ff ff       	jmp    801059aa <alltraps>
...
801060c5:	6a 3c                	push   $0x3c
  jmp alltraps
801060c7:	e9 de f8 ff ff       	jmp    801059aa <alltraps>
...
801060ce:	6a 3d                	push   $0x3d
  jmp alltraps
801060d0:	e9 d5 f8 ff ff       	jmp    801059aa <alltraps>
...
801060d7:	6a 3e                	push   $0x3e
  jmp alltraps
801060d9:	e9 cc f8 ff ff       	jmp    801059aa <alltraps>
...
801060e0:	6a 3f                	push   $0x3f
  jmp alltraps
801060e2:	e9 c3 f8 ff ff       	jmp    801059aa <alltraps>
...
801060e9:	6a 40                	push   $0x40
  jmp alltraps
801060eb:	e9 ba f8 ff ff       	jmp    801059aa <alltraps>
...
801060fb:	6a 42                	push   $0x42
  jmp alltraps
801060fd:	e9 a8 f8 ff ff       	jmp    801059aa <alltraps>
...
80106104:	6a 43                	push   $0x43
  jmp alltraps
80106106:	e9 9f f8 ff ff       	jmp    801059aa <alltraps>
...
8010610d:	6a 44                	push   $0x44
  jmp alltraps
8010610f:	e9 96 f8 ff ff       	jmp    801059aa <alltraps>
...
80106116:	6a 45                	push   $0x45
  jmp alltraps
80106118:	e9 8d f8 ff ff       	jmp    801059aa <alltraps>
...
8010611f:	6a 46                	push   $0x46
  jmp alltraps
80106121:	e9 84 f8 ff ff       	jmp    801059aa <alltraps>
...
80106128:	6a 47                	push   $0x47
  jmp alltraps
8010612a:	e9 7b f8 ff ff       	jmp    801059aa <alltraps>
...
80106131:	6a 48                	push   $0x48
  jmp alltraps
80106133:	e9 72 f8 ff ff       	jmp    801059aa <alltraps>
...
8010613a:	6a 49                	push   $0x49
  jmp alltraps
8010613c:	e9 69 f8 ff ff       	jmp    801059aa <alltraps>
...
80106143:	6a 4a                	push   $0x4a
  jmp alltraps
80106145:	e9 60 f8 ff ff       	jmp    801059aa <alltraps>
...
8010614c:	6a 4b                	push   $0x4b
  jmp alltraps
8010614e:	e9 57 f8 ff ff       	jmp    801059aa <alltraps>
...
80106155:	6a 4c                	push   $0x4c
  jmp alltraps
80106157:	e9 4e f8 ff ff       	jmp    801059aa <alltraps>
...
8010615e:	6a 4d                	push   $0x4d
  jmp alltraps
80106160:	e9 45 f8 ff ff       	jmp    801059aa <alltraps>
...
80106167:	6a 4e                	push   $0x4e
  jmp alltraps
80106169:	e9 3c f8 ff ff       	jmp    801059aa <alltraps>
...
80106170:	6a 4f                	push   $0x4f
  jmp alltraps
80106172:	e9 33 f8 ff ff       	jmp    801059aa <alltraps>
...
80106179:	6a 50                	push   $0x50
  jmp alltraps
8010617b:	e9 2a f8 ff ff       	jmp    801059aa <alltraps>
...
80106182:	6a 51                	push   $0x51
  jmp alltraps
80106184:	e9 21 f8 ff ff       	jmp    801059aa <alltraps>
...
8010618b:	6a 52                	push   $0x52
  jmp alltraps
8010618d:	e9 18 f8 ff ff       	jmp    801059aa <alltraps>
...
80106194:	6a 53                	push   $0x53
  jmp alltraps
80106196:	e9 0f f8 ff ff       	jmp    801059aa <alltraps>
...
8010619d:	6a 54                	push   $0x54
  jmp alltraps
8010619f:	e9 06 f8 ff ff       	jmp    801059aa <alltraps>
...
801061a6:	6a 55                	push   $0x55
  jmp alltraps
801061a8:	e9 fd f7 ff ff       	jmp    801059aa <alltraps>
...
801061af:	6a 56                	push   $0x56
  jmp alltraps
801061b1:	e9 f4 f7 ff ff       	jmp    801059aa <alltraps>
...
801061b8:	6a 57                	push   $0x57
  jmp alltraps
801061ba:	e9 eb f7 ff ff       	jmp    801059aa <alltraps>
...
801061c1:	6a 58                	push   $0x58
  jmp alltraps
801061c3:	e9 e2 f7 ff ff       	jmp    801059aa <alltraps>
...
801061ca:	6a 59                	push   $0x59
  jmp alltraps
801061cc:	e9 d9 f7 ff ff       	jmp    801059aa <alltraps>
...
801061d3:	6a 5a                	push   $0x5a
  jmp alltraps
801061d5:	e9 d0 f7 ff ff       	jmp    801059aa <alltraps>
...
801061dc:	6a 5b                	push   $0x5b
  jmp alltraps
801061de:	e9 c7 f7 ff ff       	jmp    801059aa <alltraps>
...
801061e5:	6a 5c                	push   $0x5c
  jmp alltraps
801061e7:	e9 be f7 ff ff       	jmp    801059aa <alltraps>
...
801061ee:	6a 5d                	push   $0x5d
  jmp alltraps
801061f0:	e9 b5 f7 ff ff       	jmp    801059aa <alltraps>
...
801061f7:	6a 5e                	push   $0x5e
  jmp alltraps
801061f9:	e9 ac f7 ff ff       	jmp    801059aa <alltraps>
...
80106200:	6a 5f                	push   $0x5f
  jmp alltraps
80106202:	e9 a3 f7 ff ff       	jmp    801059aa <alltraps>
...
80106209:	6a 60                	push   $0x60
  jmp alltraps
8010620b:	e9 9a f7 ff ff       	jmp    801059aa <alltraps>
...
80106212:	6a 61                	push   $0x61
  jmp alltraps
80106214:	e9 91 f7 ff ff       	jmp    801059aa <alltraps>
...
8010621b:	6a 62                	push   $0x62
  jmp alltraps
8010621d:	e9 88 f7 ff ff       	jmp    801059aa <alltraps>
...
80106224:	6a 63                	push   $0x63
  jmp alltraps
80106226:	e9 7f f7 ff ff       	jmp    801059aa <alltraps>
...
8010622d:	6a 64                	push   $0x64
  jmp alltraps
8010622f:	e9 76 f7 ff ff       	jmp    801059aa <alltraps>
...
80106236:	6a 65                	push   $0x65
  jmp alltraps
80106238:	e9 6d f7 ff ff       	jmp    801059aa <alltraps>
...
8010623f:	6a 66                	push   $0x66
  jmp alltraps
80106241:	e9 64 f7 ff ff       	jmp    801059aa <alltraps>
...
80106248:	6a 67                	push   $0x67
  jmp alltraps
8010624a:	e9 5b f7 ff ff       	jmp    801059aa <alltraps>
...
80106251:	6a 68                	push   $0x68
  jmp alltraps
80106253:	e9 52 f7 ff ff       	jmp    801059aa <alltraps>
...
8010625a:	6a 69                	push   $0x69
  jmp alltraps
8010625c:	e9 49 f7 ff ff       	jmp    801059aa <alltraps>
...
80106263:	6a 6a                	push   $0x6a
  jmp alltraps
80106265:	e9 40 f7 ff ff       	jmp    801059aa <alltraps>
...
8010626c:	6a 6b                	push   $0x6b
  jmp alltraps
8010626e:	e9 37 f7 ff ff       	jmp    801059aa <alltraps>
...
80106275:	6a 6c                	push   $0x6c
  jmp alltraps
80106277:	e9 2e f7 ff ff       	jmp    801059aa <alltraps>
...
8010627e:	6a 6d                	push   $0x6d
  jmp alltraps
80106280:	e9 25 f7 ff ff       	jmp    801059aa <alltraps>
...
80106287:	6a 6e                	push   $0x6e
  jmp alltraps
80106289:	e9 1c f7 ff ff       	jmp    801059aa <alltraps>
...
80106290:	6a 6f                	push   $0x6f
  jmp alltraps
80106292:	e9 13 f7 ff ff       	jmp    801059aa <alltraps>
...
80106299:	6a 70                	push   $0x70
  jmp alltraps
8010629b:	e9 0a f7 ff ff       	jmp    801059aa <alltraps>
...
801062a2:	6a 71                	push   $0x71
  jmp alltraps
801062a4:	e9 01 f7 ff ff       	jmp    801059aa <alltraps>
...
801062ab:	6a 72                	push   $0x72
  jmp alltraps
801062ad:	e9 f8 f6 ff ff       	jmp    801059aa <alltraps>
...
801062b4:	6a 73                	push   $0x73
  jmp alltraps
801062b6:	e9 ef f6 ff ff       	jmp    801059aa <alltraps>
...
801062bd:	6a 74                	push   $0x74
  jmp alltraps
801062bf:	e9 e6 f6 ff ff       	jmp    801059aa <alltraps>
...
801062c6:	6a 75                	push   $0x75
  jmp alltraps
801062c8:	e9 dd f6 ff ff       	jmp    801059aa <alltraps>
...
801062cf:	6a 76                	push   $0x76
  jmp alltraps
801062d1:	e9 d4 f6 ff ff       	jmp    801059aa <alltraps>
...
801062d8:	6a 77                	push   $0x77
  jmp alltraps
801062da:	e9 cb f6 ff ff       	jmp    801059aa <alltraps>
...
801062e1:	6a 78                	push   $0x78
  jmp alltraps
801062e3:	e9 c2 f6 ff ff       	jmp    801059aa <alltraps>
...
801062ea:	6a 79                	push   $0x79
  jmp alltraps
801062ec:	e9 b9 f6 ff ff       	jmp    801059aa <alltraps>
...
801062f3:	6a 7a                	push   $0x7a
  jmp alltraps
801062f5:	e9 b0 f6 ff ff       	jmp    801059aa <alltraps>
...
801062fc:	6a 7b                	push   $0x7b
  jmp alltraps
801062fe:	e9 a7 f6 ff ff       	jmp    801059aa <alltraps>
...
80106305:	6a 7c                	push   $0x7c
  jmp alltraps
80106307:	e9 9e f6 ff ff       	jmp    801059aa <alltraps>
...
8010630e:	6a 7d                	push   $0x7d
  jmp alltraps
80106310:	e9 95 f6 ff ff       	jmp    801059aa <alltraps>
...
80106317:	6a 7e                	push   $0x7e
  jmp alltraps
80106319:	e9 8c f6 ff ff       	jmp    801059aa <alltraps>
...
80106320:	6a 7f                	push   $0x7f
  jmp alltraps
80106322:	e9 83 f6 ff ff       	jmp    801059aa <alltraps>
...
80106329:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010632e:	e9 77 f6 ff ff       	jmp    801059aa <alltraps>
...
80106335:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010633a:	e9 6b f6 ff ff       	jmp    801059aa <alltraps>
...
80106341:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106346:	e9 5f f6 ff ff       	jmp    801059aa <alltraps>
...
8010634d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106352:	e9 53 f6 ff ff       	jmp    801059aa <alltraps>
...
80106359:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010635e:	e9 47 f6 ff ff       	jmp    801059aa <alltraps>
...
80106365:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010636a:	e9 3b f6 ff ff       	jmp    801059aa <alltraps>
...
80106371:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106376:	e9 2f f6 ff ff       	jmp    801059aa <alltraps>
...
8010637d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106382:	e9 23 f6 ff ff       	jmp    801059aa <alltraps>
...
80106389:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010638e:	e9 17 f6 ff ff       	jmp    801059aa <alltraps>
...
80106395:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010639a:	e9 0b f6 ff ff       	jmp    801059aa <alltraps>
...
801063a1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801063a6:	e9 ff f5 ff ff       	jmp    801059aa <alltraps>
...
801063ad:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801063b2:	e9 f3 f5 ff ff       	jmp    801059aa <alltraps>
...
801063b9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801063be:	e9 e7 f5 ff ff       	jmp    801059aa <alltraps>
...
801063c5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801063ca:	e9 db f5 ff ff       	jmp    801059aa <alltraps>
...
801063d1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801063d6:	e9 cf f5 ff ff       	jmp    801059aa <alltraps>
...
801063dd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801063e2:	e9 c3 f5 ff ff       	jmp    801059aa <alltraps>
...
801063e9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801063ee:	e9 b7 f5 ff ff       	jmp    801059aa <alltraps>
...
801063f5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801063fa:	e9 ab f5 ff ff       	jmp    801059aa <alltraps>
...
80106401:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106406:	e9 9f f5 ff ff       	jmp    801059aa <alltraps>
...
8010640d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106412:	e9 93 f5 ff ff       	jmp    801059aa <alltraps>
...
80106419:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010641e:	e9 87 f5 ff ff       	jmp    801059aa <alltraps>
...
80106425:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010642a:	e9 7b f5 ff ff       	jmp    801059aa <alltraps>
...
80106431:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106436:	e9 6f f5 ff ff       	jmp    801059aa <alltraps>
...
8010643d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106442:	e9 63 f5 ff ff       	jmp    801059aa <alltraps>
...
80106449:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010644e:	e9 57 f5 ff ff       	jmp    801059aa <alltraps>
...
80106455:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010645a:	e9 4b f5 ff ff       	jmp    801059aa <alltraps>
...
80106461:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106466:	e9 3f f5 ff ff       	jmp    801059aa <alltraps>
...
8010646d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106472:	e9 33 f5 ff ff       	jmp    801059aa <alltraps>
...
80106479:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010647e:	e9 27 f5 ff ff       	jmp    801059aa <alltraps>
...
80106485:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010648a:	e9 1b f5 ff ff       	jmp    801059aa <alltraps>
...
80106491:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106496:	e9 0f f5 ff ff       	jmp    801059aa <alltraps>
...
8010649d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801064a2:	e9 03 f5 ff ff       	jmp    801059aa <alltraps>
...
801064a9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801064ae:	e9 f7 f4 ff ff       	jmp    801059aa <alltraps>
...
801064b5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801064ba:	e9 eb f4 ff ff       	jmp    801059aa <alltraps>
...
801064c1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801064c6:	e9 df f4 ff ff       	jmp    801059aa <alltraps>
...
801064cd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801064d2:	e9 d3 f4 ff ff       	jmp    801059aa <alltraps>
...
801064d9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801064de:	e9 c7 f4 ff ff       	jmp    801059aa <alltraps>
...
801064e5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801064ea:	e9 bb f4 ff ff       	jmp    801059aa <alltraps>
...
801064f1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801064f6:	e9 af f4 ff ff       	jmp    801059aa <alltraps>
...
801064fd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106502:	e9 a3 f4 ff ff       	jmp    801059aa <alltraps>
...
80106509:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010650e:	e9 97 f4 ff ff       	jmp    801059aa <alltraps>
...
80106515:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010651a:	e9 8b f4 ff ff       	jmp    801059aa <alltraps>
...
80106521:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106526:	e9 7f f4 ff ff       	jmp    801059aa <alltraps>
...
8010652d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106532:	e9 73 f4 ff ff       	jmp    801059aa <alltraps>
...
80106539:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010653e:	e9 67 f4 ff ff       	jmp    801059aa <alltraps>
...
80106545:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010654a:	e9 5b f4 ff ff       	jmp    801059aa <alltraps>
...
80106551:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106556:	e9 4f f4 ff ff       	jmp    801059aa <alltraps>
...
8010655d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106562:	e9 43 f4 ff ff       	jmp    801059aa <alltraps>
...
80106569:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010656e:	e9 37 f4 ff ff       	jmp    801059aa <alltraps>
...
80106575:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010657a:	e9 2b f4 ff ff       	jmp    801059aa <alltraps>
...
80106581:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106586:	e9 1f f4 ff ff       	jmp    801059aa <alltraps>
...
8010658d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106592:	e9 13 f4 ff ff       	jmp    801059aa <alltraps>
...
80106599:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010659e:	e9 07 f4 ff ff       	jmp    801059aa <alltraps>
...
801065a5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801065aa:	e9 fb f3 ff ff       	jmp    801059aa <alltraps>
...
801065b1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801065b6:	e9 ef f3 ff ff       	jmp    801059aa <alltraps>
...
801065bd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801065c2:	e9 e3 f3 ff ff       	jmp    801059aa <alltraps>
...
801065c9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801065ce:	e9 d7 f3 ff ff       	jmp    801059aa <alltraps>
...
801065d5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801065da:	e9 cb f3 ff ff       	jmp    801059aa <alltraps>
...
801065e1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801065e6:	e9 bf f3 ff ff       	jmp    801059aa <alltraps>
...
801065ed:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801065f2:	e9 b3 f3 ff ff       	jmp    801059aa <alltraps>
...
801065f9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801065fe:	e9 a7 f3 ff ff       	jmp    801059aa <alltraps>
...
80106605:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010660a:	e9 9b f3 ff ff       	jmp    801059aa <alltraps>
...
80106611:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106616:	e9 8f f3 ff ff       	jmp    801059aa <alltraps>
...
8010661d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106622:	e9 83 f3 ff ff       	jmp    801059aa <alltraps>
...
80106629:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010662e:	e9 77 f3 ff ff       	jmp    801059aa <alltraps>
...
80106635:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010663a:	e9 6b f3 ff ff       	jmp    801059aa <alltraps>
...
80106641:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106646:	e9 5f f3 ff ff       	jmp    801059aa <alltraps>
...
8010664d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106652:	e9 53 f3 ff ff       	jmp    801059aa <alltraps>
...
80106659:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010665e:	e9 47 f3 ff ff       	jmp    801059aa <alltraps>
...
80106665:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010666a:	e9 3b f3 ff ff       	jmp    801059aa <alltraps>
...
80106671:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106676:	e9 2f f3 ff ff       	jmp    801059aa <alltraps>
...
8010667d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106682:	e9 23 f3 ff ff       	jmp    801059aa <alltraps>
...
80106689:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010668e:	e9 17 f3 ff ff       	jmp    801059aa <alltraps>
...
80106695:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010669a:	e9 0b f3 ff ff       	jmp    801059aa <alltraps>
...
801066a1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801066a6:	e9 ff f2 ff ff       	jmp    801059aa <alltraps>
...
801066ad:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801066b2:	e9 f3 f2 ff ff       	jmp    801059aa <alltraps>
...
801066b9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801066be:	e9 e7 f2 ff ff       	jmp    801059aa <alltraps>
...
801066c5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801066ca:	e9 db f2 ff ff       	jmp    801059aa <alltraps>
...
801066d1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801066d6:	e9 cf f2 ff ff       	jmp    801059aa <alltraps>
...
801066dd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801066e2:	e9 c3 f2 ff ff       	jmp    801059aa <alltraps>
...
801066e9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801066ee:	e9 b7 f2 ff ff       	jmp    801059aa <alltraps>
...
801066f5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801066fa:	e9 ab f2 ff ff       	jmp    801059aa <alltraps>
...
80106701:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106706:	e9 9f f2 ff ff       	jmp    801059aa <alltraps>
...
8010670d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106712:	e9 93 f2 ff ff       	jmp    801059aa <alltraps>
...
80106719:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010671e:	e9 87 f2 ff ff       	jmp    801059aa <alltraps>
...
80106725:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010672a:	e9 7b f2 ff ff       	jmp    801059aa <alltraps>
...
80106731:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106736:	e9 6f f2 ff ff       	jmp    801059aa <alltraps>
...
8010673d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106742:	e9 63 f2 ff ff       	jmp    801059aa <alltraps>
...
80106749:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010674e:	e9 57 f2 ff ff       	jmp    801059aa <alltraps>
...
80106755:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010675a:	e9 4b f2 ff ff       	jmp    801059aa <alltraps>
...
80106761:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106766:	e9 3f f2 ff ff       	jmp    801059aa <alltraps>
...
8010676d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106772:	e9 33 f2 ff ff       	jmp    801059aa <alltraps>
...
80106779:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010677e:	e9 27 f2 ff ff       	jmp    801059aa <alltraps>
...
80106785:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010678a:	e9 1b f2 ff ff       	jmp    801059aa <alltraps>
...
80106791:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106796:	e9 0f f2 ff ff       	jmp    801059aa <alltraps>
...
8010679d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801067a2:	e9 03 f2 ff ff       	jmp    801059aa <alltraps>
...
801067a9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801067ae:	e9 f7 f1 ff ff       	jmp    801059aa <alltraps>
...
801067b5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801067ba:	e9 eb f1 ff ff       	jmp    801059aa <alltraps>
...
801067c1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801067c6:	e9 df f1 ff ff       	jmp    801059aa <alltraps>
...
801067cd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801067d2:	e9 d3 f1 ff ff       	jmp    801059aa <alltraps>
...
801067d9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801067de:	e9 c7 f1 ff ff       	jmp    801059aa <alltraps>
...
801067e5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801067ea:	e9 bb f1 ff ff       	jmp    801059aa <alltraps>
...
801067f1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801067f6:	e9 af f1 ff ff       	jmp    801059aa <alltraps>
...
801067fd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106802:	e9 a3 f1 ff ff       	jmp    801059aa <alltraps>
...
80106809:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010680e:	e9 97 f1 ff ff       	jmp    801059aa <alltraps>
...
80106815:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010681a:	e9 8b f1 ff ff       	jmp    801059aa <alltraps>
...
80106821:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106826:	e9 7f f1 ff ff       	jmp    801059aa <alltraps>
...
8010682d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106832:	e9 73 f1 ff ff       	jmp    801059aa <alltraps>
...
80106839:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010683e:	e9 67 f1 ff ff       	jmp    801059aa <alltraps>
...
80106845:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010684a:	e9 5b f1 ff ff       	jmp    801059aa <alltraps>
...
80106851:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106856:	e9 4f f1 ff ff       	jmp    801059aa <alltraps>
...
8010685d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106862:	e9 43 f1 ff ff       	jmp    801059aa <alltraps>
...
80106869:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010686e:	e9 37 f1 ff ff       	jmp    801059aa <alltraps>
...
80106875:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010687a:	e9 2b f1 ff ff       	jmp    801059aa <alltraps>
...
80106881:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106886:	e9 1f f1 ff ff       	jmp    801059aa <alltraps>
...
8010688d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106892:	e9 13 f1 ff ff       	jmp    801059aa <alltraps>
...
80106899:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010689e:	e9 07 f1 ff ff       	jmp    801059aa <alltraps>
...
801068a5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801068aa:	e9 fb f0 ff ff       	jmp    801059aa <alltraps>
...
801068b1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801068b6:	e9 ef f0 ff ff       	jmp    801059aa <alltraps>
...
801068bd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801068c2:	e9 e3 f0 ff ff       	jmp    801059aa <alltraps>
...
801068c9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801068ce:	e9 d7 f0 ff ff       	jmp    801059aa <alltraps>
...
801068d5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801068da:	e9 cb f0 ff ff       	jmp    801059aa <alltraps>
...
801068e1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801068e6:	e9 bf f0 ff ff       	jmp    801059aa <alltraps>
...
801068ed:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801068f2:	e9 b3 f0 ff ff       	jmp    801059aa <alltraps>
...
801068f9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801068fe:	e9 a7 f0 ff ff       	jmp    801059aa <alltraps>
...
80106905:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010690a:	e9 9b f0 ff ff       	jmp    801059aa <alltraps>
...
80106911:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106916:	e9 8f f0 ff ff       	jmp    801059aa <alltraps>
...
8010691d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106922:	e9 83 f0 ff ff       	jmp    801059aa <alltraps>
...
8010694a:	73 45                	jae    80106991 <deallocuvm.part.0+0x61>
8010694c:	89 c7                	mov    %eax,%edi
8010694e:	eb 0a                	jmp    8010695a <deallocuvm.part.0+0x2a>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106950:	8d 59 01             	lea    0x1(%ecx),%ebx
80106953:	c1 e3 16             	shl    $0x16,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106956:	39 da                	cmp    %ebx,%edx
80106958:	76 37                	jbe    80106991 <deallocuvm.part.0+0x61>
  pde = &pgdir[PDX(va)];
8010695a:	89 d9                	mov    %ebx,%ecx
8010695c:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
8010695f:	8b 04 8f             	mov    (%edi,%ecx,4),%eax
80106962:	a8 01                	test   $0x1,%al
80106964:	74 ea                	je     80106950 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
80106966:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106968:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
8010696d:	c1 ee 0a             	shr    $0xa,%esi
80106970:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
80106976:	8d b4 30 00 00 00 80 	lea    -0x80000000(%eax,%esi,1),%esi
    if(!pte)
8010697d:	85 f6                	test   %esi,%esi
8010697f:	74 cf                	je     80106950 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
80106981:	8b 06                	mov    (%esi),%eax
80106983:	a8 01                	test   $0x1,%al
80106985:	75 19                	jne    801069a0 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
80106987:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010698d:	39 da                	cmp    %ebx,%edx
8010698f:	77 c9                	ja     8010695a <deallocuvm.part.0+0x2a>
      kfree(v);
      *pte = 0;
    }
  }
...
80106991:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
801069b9:	e8 12 bc ff ff       	call   801025d0 <kfree>
      *pte = 0;
801069be:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  for(; a  < oldsz; a += PGSIZE){
801069c4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801069c7:	83 c4 10             	add    $0x10,%esp
801069ca:	eb 8a                	jmp    80106956 <deallocuvm.part.0+0x26>
        panic("kfree");
801069cc:	83 ec 0c             	sub    $0xc,%esp
801069cf:	68 66 77 10 80       	push   $0x80107766
...
80106a5e:	e8 2d bd ff ff       	call   80102790 <kalloc>
...
80106a75:	e8 06 dd ff ff       	call   80104780 <memset>
...
80106abd:	68 ac 7d 10 80       	push   $0x80107dac
...
80106ad3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106ad6:	e8 95 cf ff ff       	call   80103a70 <cpuid>
  pd[0] = size-1;
...
80106b60:	a1 04 45 11 80       	mov    0x80114504,%eax
...
80106b9f:	e8 5c ce ff ff       	call   80103a00 <mycpu>
80106ba4:	89 c3                	mov    %eax,%ebx
80106ba6:	e8 55 ce ff ff       	call   80103a00 <mycpu>
...
80106bb8:	e8 43 ce ff ff       	call   80103a00 <mycpu>
...
80106c01:	e8 fa cd ff ff       	call   80103a00 <mycpu>
80106c06:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106c0d:	e8 ee cd ff ff       	call   80103a00 <mycpu>
...
80106c24:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c27:	e8 d4 cd ff ff       	call   80103a00 <mycpu>
...
80106c9b:	77 4b                	ja     80106ce8 <inituvm+0x68>
  mem = kalloc();
80106c9d:	e8 ee ba ff ff       	call   80102790 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106caf:	e8 cc da ff ff       	call   80104780 <memset>
...
80106ce2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106ce3:	e9 38 db ff ff       	jmp    80104820 <memmove>
    panic("inituvm: more than a page");
80106ce8:	83 ec 0c             	sub    $0xc,%esp
80106ceb:	68 f1 7d 10 80       	push   $0x80107df1
...
80106d50:	68 0b 7e 10 80       	push   $0x80107e0b
...
80106d9e:	e8 fd ad ff ff       	call   80101ba0 <readi>
...
80106dd8:	68 ac 7e 10 80       	push   $0x80107eac
...
80106e3b:	e8 40 d9 ff ff       	call   80104780 <memset>
...
80106e69:	76 48                	jbe    80106eb3 <allocuvm+0xc3>
    mem = kalloc();
80106e6b:	e8 20 b9 ff ff       	call   80102790 <kalloc>
...
80106e79:	68 29 7e 10 80       	push   $0x80107e29
80106e7e:	e8 fd 97 ff ff       	call   80100680 <cprintf>
  if(newsz >= oldsz)
...
80106edb:	68 41 7e 10 80       	push   $0x80107e41
80106ee0:	e8 9b 97 ff ff       	call   80100680 <cprintf>
  if(newsz >= oldsz)
...
80106f00:	e8 cb b6 ff ff       	call   801025d0 <kfree>
      return 0;
...
80106f9e:	e8 2d b6 ff ff       	call   801025d0 <kfree>
...
80106fb3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106fb4:	e9 17 b6 ff ff       	jmp    801025d0 <kfree>
    panic("freevm: no pgdir");
80106fb9:	83 ec 0c             	sub    $0xc,%esp
80106fbc:	68 5d 7e 10 80       	push   $0x80107e5d
...
80106fd5:	e8 b6 b7 ff ff       	call   80102790 <kalloc>
...
80106ff0:	e8 8b d7 ff ff       	call   80104780 <memset>
...
80107001:	ff 73 0c             	pushl  0xc(%ebx)
...
8010705b:	a3 04 45 11 80       	mov    %eax,0x80114504
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010708c:	68 6e 7e 10 80       	push   $0x80107e6e
...
80107102:	68 78 7e 10 80       	push   $0x80107e78
...
8010713f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107145:	e8 46 b6 ff ff       	call   80102790 <kalloc>
...
80107160:	e8 bb d6 ff ff       	call   80104820 <memmove>
...
801071ac:	e8 1f b4 ff ff       	call   801025d0 <kfree>
      goto bad;
801071b1:	83 c4 10             	add    $0x10,%esp
  freevm(d);
801071b4:	83 ec 0c             	sub    $0xc,%esp
801071b7:	ff 75 e0             	pushl  -0x20(%ebp)
...
801071d7:	68 92 7e 10 80       	push   $0x80107e92
...
80107316:	0f 0b                	ud2    
80107318:	66 90                	xchg   %ax,%ax
8010731a:	66 90                	xchg   %ax,%ax
8010731c:	66 90                	xchg   %ax,%ax
...
80107321:	b8 24 45 11 80       	mov    $0x80114524,%eax
80107326:	89 e5                	mov    %esp,%ebp
80107328:	8b 55 08             	mov    0x8(%ebp),%edx
    /* setting initial seeds to mt[N] using         */
    /* the generator Line 25 of Table 1 in          */
    /* [KNUTH 1981, The Art of Computer Programming */
    /*    Vol. 2 (2nd Ed.), pp102]                  */
    mt[0]= seed & 0xffffffff;
8010732b:	89 15 20 45 11 80    	mov    %edx,0x80114520
    for (mti=1; mti<N; mti++)
80107331:	eb 08                	jmp    8010733b <sgenrand+0x1b>
...
80107341:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
80107343:	3d dc 4e 11 80       	cmp    $0x80114edc,%eax
80107348:	75 ee                	jne    80107338 <sgenrand+0x18>
8010734a:	c7 05 60 a4 10 80 70 	movl   $0x270,0x8010a460
80107351:	02 00 00 
}
80107354:	5d                   	pop    %ebp
80107355:	c3                   	ret    
...
80107360:	a1 60 a4 10 80       	mov    0x8010a460,%eax
80107365:	3d 6f 02 00 00       	cmp    $0x26f,%eax
8010736a:	7f 3c                	jg     801073a8 <genrand+0x48>
    ...
    y = mt[mti++];
8010736c:	8d 50 01             	lea    0x1(%eax),%edx
8010736f:	8b 04 85 20 45 11 80 	mov    -0x7feebae0(,%eax,4),%eax
80107376:	89 15 60 a4 10 80    	mov    %edx,0x8010a460
    y ^= TEMPERING_SHIFT_U(y);
8010737c:	89 c2                	mov    %eax,%edx
8010737e:	c1 ea 0b             	shr    $0xb,%edx
80107381:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_S(y) & TEMPERING_MASK_B;
80107383:	89 d0                	mov    %edx,%eax
80107385:	c1 e0 07             	shl    $0x7,%eax
80107388:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
8010738d:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_T(y) & TEMPERING_MASK_C;
8010738f:	89 d0                	mov    %edx,%eax
80107391:	c1 e0 0f             	shl    $0xf,%eax
80107394:	25 00 00 c6 ef       	and    $0xefc60000,%eax
80107399:	31 d0                	xor    %edx,%eax
    y ^= TEMPERING_SHIFT_L(y);
8010739b:	89 c2                	mov    %eax,%edx
8010739d:	c1 ea 12             	shr    $0x12,%edx
801073a0:	31 d0                	xor    %edx,%eax

    return y & RAND_MAX; /* for long  generation */
801073a2:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
}
801073a7:	c3                   	ret    
        if (mti == N+1)   /* if sgenrand() has not been called, */
801073a8:	3d 71 02 00 00       	cmp    $0x271,%eax
801073ad:	0f 84 ce 00 00 00    	je     80107481 <genrand+0x121>
    mt[0]= seed & 0xffffffff;
801073b3:	31 c0                	xor    %eax,%eax
801073b5:	8d 76 00             	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
801073b8:	8b 0c 85 20 45 11 80 	mov    -0x7feebae0(,%eax,4),%ecx
801073bf:	83 c0 01             	add    $0x1,%eax
801073c2:	8b 14 85 20 45 11 80 	mov    -0x7feebae0(,%eax,4),%edx
801073c9:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
801073cf:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
801073d5:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+M] ^ (y >> 1) ^ mag01[y & 0x1];
801073d7:	89 d1                	mov    %edx,%ecx
801073d9:	83 e2 01             	and    $0x1,%edx
801073dc:	d1 e9                	shr    %ecx
801073de:	33 0c 85 50 4b 11 80 	xor    -0x7feeb4b0(,%eax,4),%ecx
801073e5:	33 0c 95 d0 7e 10 80 	xor    -0x7fef8130(,%edx,4),%ecx
801073ec:	89 0c 85 1c 45 11 80 	mov    %ecx,-0x7feebae4(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
801073f3:	3d e3 00 00 00       	cmp    $0xe3,%eax
801073f8:	75 be                	jne    801073b8 <genrand+0x58>
801073fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
80107400:	8b 0c 85 20 45 11 80 	mov    -0x7feebae0(,%eax,4),%ecx
80107407:	83 c0 01             	add    $0x1,%eax
8010740a:	8b 14 85 20 45 11 80 	mov    -0x7feebae0(,%eax,4),%edx
80107411:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
80107417:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
8010741d:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+(M-N)] ^ (y >> 1) ^ mag01[y & 0x1];
8010741f:	89 d1                	mov    %edx,%ecx
80107421:	83 e2 01             	and    $0x1,%edx
80107424:	d1 e9                	shr    %ecx
80107426:	33 0c 85 90 41 11 80 	xor    -0x7feebe70(,%eax,4),%ecx
8010742d:	33 0c 95 d0 7e 10 80 	xor    -0x7fef8130(,%edx,4),%ecx
80107434:	89 0c 85 1c 45 11 80 	mov    %ecx,-0x7feebae4(,%eax,4)
        for (;kk<N-1;kk++) {
8010743b:	3d 6f 02 00 00       	cmp    $0x26f,%eax
80107440:	75 be                	jne    80107400 <genrand+0xa0>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
80107442:	a1 20 45 11 80       	mov    0x80114520,%eax
80107447:	8b 0d dc 4e 11 80    	mov    0x80114edc,%ecx
8010744d:	89 c2                	mov    %eax,%edx
8010744f:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
80107455:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
8010745b:	09 d1                	or     %edx,%ecx
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1];
8010745d:	89 ca                	mov    %ecx,%edx
8010745f:	83 e1 01             	and    $0x1,%ecx
80107462:	d1 ea                	shr    %edx
80107464:	33 15 50 4b 11 80    	xor    0x80114b50,%edx
8010746a:	33 14 8d d0 7e 10 80 	xor    -0x7fef8130(,%ecx,4),%edx
80107471:	89 15 dc 4e 11 80    	mov    %edx,0x80114edc
80107477:	ba 01 00 00 00       	mov    $0x1,%edx
8010747c:	e9 f5 fe ff ff       	jmp    80107376 <genrand+0x16>
    mt[0]= seed & 0xffffffff;
80107481:	b8 24 45 11 80       	mov    $0x80114524,%eax
80107486:	b9 dc 4e 11 80       	mov    $0x80114edc,%ecx
8010748b:	ba 05 11 00 00       	mov    $0x1105,%edx
80107490:	c7 05 20 45 11 80 05 	movl   $0x1105,0x80114520
80107497:	11 00 00 
    for (mti=1; mti<N; mti++)
8010749a:	eb 07                	jmp    801074a3 <genrand+0x143>
8010749c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801074a0:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
801074a3:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
801074a9:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
801074ab:	39 c1                	cmp    %eax,%ecx
801074ad:	75 f1                	jne    801074a0 <genrand+0x140>
801074af:	e9 ff fe ff ff       	jmp    801073b3 <genrand+0x53>
...
801074da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
   x = genrand();
801074e0:	e8 7b fe ff ff       	call   80107360 <genrand>
  while (num_rand - defect <= (unsigned long)x);
...
801074eb:	5b                   	pop    %ebx
  long ret = x/bin_size;
801074ec:	f7 f6                	div    %esi
  return ret;
801074ee:	ba 01 00 00 00       	mov    $0x1,%edx
}
801074f3:	5e                   	pop    %esi
801074f4:	5d                   	pop    %ebp
  return ret;
801074f5:	85 c0                	test   %eax,%eax
801074f7:	0f 44 c2             	cmove  %edx,%eax
}
801074fa:	c3                   	ret    
