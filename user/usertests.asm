...
user/_usertests:     formato del fichero elf32-i386
...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12b:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1bf:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1d6:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1ed:	ff 35 2c 5e 00 00    	pushl  0x5e2c
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     285:	ff 35 2c 5e 00 00    	pushl  0x5e2c
     ...
     2a0:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "fork failed\n");
     ...
     2b7:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    exit();
     ...
     2ce:	ff 35 2c 5e 00 00    	pushl  0x5e2c
     ...
     2e5:	ff 35 2c 5e 00 00    	pushl  0x5e2c
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     30b:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     356:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  printf(stdout, "openiput test ok\n");
     ...
     39a:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "fork failed\n");
     ...
     3bc:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3d3:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "unlink failed\n");
     ...
     3ea:	ff 35 2c 5e 00 00    	pushl  0x5e2c
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     47f:	ff 35 2c 5e 00 00    	pushl  0x5e2c
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 2c 5e 00 00    	pushl  0x5e2c
     ...
     5de:	ff 35 2c 5e 00 00    	pushl  0x5e2c
     ...
     5f7:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     60e:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "read failed\n");
     ...
     625:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "unlink small failed\n");
     ...
     63c:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     653:	ff 35 2c 5e 00 00    	pushl  0x5e2c
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 2c 5e 00 00    	pushl  0x5e2c
     ...
     793:	ff 35 2c 5e 00 00    	pushl  0x5e2c
     ...
     7aa:	ff 35 2c 5e 00 00    	pushl  0x5e2c
     ...
     7c3:	ff 35 2c 5e 00 00    	pushl  0x5e2c
     ...
     7de:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7f5:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     80c:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "unlink big failed\n");
     ...
     823:	ff 35 2c 5e 00 00    	pushl  0x5e2c
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 2c 5e 00 00    	pushl  0x5e2c
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     8fb:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     98f:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9a6:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9bd:	ff 35 2c 5e 00 00    	pushl  0x5e2c
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 2c 5e 00 00    	pushl  0x5e2c
     9e1:	e8 4a 30 00 00       	call   3a30 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 30 5e 00 00       	push   $0x5e30
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 2c 5e 00 00    	pushl  0x5e2c
...
00000bb0 <preempt>:
{
  ...
  printf(1, "preempt ok\n");
    ...
    printf(1, "preempt read error");
     ...
     cda:	68 4a 41 00 00       	push   $0x414a
     cdf:	6a 01                	push   $0x1
    ...
    return;
     ...
     cee:	68 36 41 00 00       	push   $0x4136
     cf3:	6a 01                	push   $0x1
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete ok\n");
    ...
    1344:	50                   	push   %eax
    1345:	57                   	push   %edi
    1346:	68 34 4f 00 00       	push   $0x4f34
    134b:	6a 01                	push   $0x1
    ...
    13d5:	52                   	push   %edx
    13d6:	52                   	push   %edx
    13d7:	68 51 3e 00 00       	push   $0x3e51
    13dc:	6a 01                	push   $0x1
    ...
    13f8:	57                   	push   %edi
    13f9:	68 10 4f 00 00       	push   $0x4f10
    13fe:	6a 01                	push   $0x1
    ...
    140d:	68 d9 4c 00 00       	push   $0x4cd9
    1412:	6a 01                	push   $0x1
    ...
    1421:	68 9f 44 00 00       	push   $0x449f
    1426:	6a 01                	push   $0x1
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    17ee:	68 f1 43 00 00       	push   $0x43f1
    17f3:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    1898:	53                   	push   %ebx
    1899:	68 04 44 00 00       	push   $0x4404
    189e:	6a 01                	push   $0x1
    ...
    18b3:	53                   	push   %ebx
    18b4:	68 01 44 00 00       	push   $0x4401
  ...
  for(i = 0; i < 40; i++){
    18d3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18d6:	53                   	push   %ebx
    18d7:	68 01 44 00 00       	push   $0x4401
  ...
  fd = open(".", 0);
    ...
    1903:	5f                   	pop    %edi
    1904:	6a 00                	push   $0x0
    1906:	68 0e 46 00 00       	push   $0x460e
...
00001ae0 <linkunlink>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b71:	68 f1 46 00 00       	push   $0x46f1
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b9a:	68 79 44 00 00       	push   $0x4479
    1b9f:	6a 01                	push   $0x1
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d50:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fb5:	68 30 4c 00 00       	push   $0x4c30
    2fba:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    2fee:	6a 01                	push   $0x1
    2ff0:	68 f1 46 00 00       	push   $0x46f1
    ...
    3037:	53                   	push   %ebx
    3038:	56                   	push   %esi
    3039:	68 93 4b 00 00       	push   $0x4b93
    303e:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    3054:	68 d9 4c 00 00       	push   $0x4cd9
    3059:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    306c:	50                   	push   %eax
    306d:	53                   	push   %ebx
    306e:	68 fc 4b 00 00       	push   $0x4bfc
    3073:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    308b:	50                   	push   %eax
    308c:	53                   	push   %ebx
    308d:	68 dc 53 00 00       	push   $0x53dc
    3092:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    30a2:	56                   	push   %esi
    30a3:	56                   	push   %esi
    30a4:	68 0c 53 00 00       	push   $0x530c
    30a9:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    30b9:	50                   	push   %eax
    30ba:	50                   	push   %eax
    30bb:	68 ae 4b 00 00       	push   $0x4bae
    30c0:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    30d0:	51                   	push   %ecx
    30d1:	51                   	push   %ecx
    30d2:	68 ac 53 00 00       	push   $0x53ac
    30d7:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    30e7:	50                   	push   %eax
    30e8:	50                   	push   %eax
    30e9:	68 15 4c 00 00       	push   $0x4c15
    30ee:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    30fe:	52                   	push   %edx
    30ff:	52                   	push   %edx
    3100:	68 d1 40 00 00       	push   $0x40d1
    3105:	6a 01                	push   $0x1
    ...
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 c5 4b 00 00       	push   $0x4bc5
    311d:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 84 53 00 00       	push   $0x5384
    3134:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 4c 53 00 00       	push   $0x534c
    314b:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 e1 4b 00 00       	push   $0x4be1
    3162:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    319a:	68 3e 4c 00 00       	push   $0x4c3e
    319f:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 4d 4c 00 00       	push   $0x4c4d
  ...
  printf(stdout, "validate ok\n");
    ...
    3204:	68 71 4c 00 00       	push   $0x4c71
    3209:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    3226:	68 58 4c 00 00       	push   $0x4c58
    322b:	ff 35 2c 5e 00 00    	pushl  0x5e2c
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    3246:	68 7e 4c 00 00       	push   $0x4c7e
    324b:	ff 35 2c 5e 00 00    	pushl  0x5e2c
  ...
  printf(stdout, "bss test ok\n");
    ...
    3276:	68 99 4c 00 00       	push   $0x4c99
    327b:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    328e:	68 88 4c 00 00       	push   $0x4c88
    3293:	ff 35 2c 5e 00 00    	pushl  0x5e2c
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    32b6:	68 a6 4c 00 00       	push   $0x4ca6
  ...
  fd = open("bigarg-ok", 0);
    ...
    32da:	6a 00                	push   $0x0
    32dc:	68 a6 4c 00 00       	push   $0x4ca6
  ...
  unlink("bigarg-ok");
    32fa:	c7 04 24 a6 4c 00 00 	movl   $0x4ca6,(%esp)
    ...
    3310:	c7 04 85 80 a5 00 00 	movl   $0x5400,0xa580(,%eax,4)
    3317:	00 54 00 00 
    ...
    3323:	51                   	push   %ecx
    3324:	51                   	push   %ecx
    3325:	68 b0 4c 00 00       	push   $0x4cb0
    332a:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    args[MAXARG-1] = 0;
    ...
    3346:	68 7d 3e 00 00       	push   $0x3e7d
    334b:	e8 bb 05 00 00       	call   390b <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 bd 4c 00 00       	push   $0x4cbd
    3357:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    335d:	e8 ce 06 00 00       	call   3a30 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3362:	58                   	pop    %eax
    3363:	5a                   	pop    %edx
    3364:	68 00 02 00 00       	push   $0x200
    3369:	68 a6 4c 00 00       	push   $0x4ca6
    ...
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 e6 4c 00 00       	push   $0x4ce6
    3387:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 cd 4c 00 00       	push   $0x4ccd
    339e:	ff 35 2c 5e 00 00    	pushl  0x5e2c
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    33bb:	68 fb 4c 00 00       	push   $0x4cfb
    33c0:	6a 01                	push   $0x1
    ...
    3441:	50                   	push   %eax
    3442:	68 08 4d 00 00       	push   $0x4d08
    3447:	6a 01                	push   $0x1
    ...
    3492:	53                   	push   %ebx
    3493:	68 24 4d 00 00       	push   $0x4d24
    3498:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    34bc:	50                   	push   %eax
    34bd:	68 14 4d 00 00       	push   $0x4d14
    34c2:	6a 01                	push   $0x1
  ...
  printf(1, "fsfull test finished\n");
    ...
    355c:	68 34 4d 00 00       	push   $0x4d34
    3561:	6a 01                	push   $0x1
...
00003660 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3660:	69 05 28 5e 00 00 0d 	imul   $0x19660d,0x5e28,%eax
    3667:	66 19 00 
    366a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    366f:	a3 28 5e 00 00       	mov    %eax,0x5e28
}
    3674:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3bb4:	eb 1a                	jmp    3bd0 <printf+0x1a0>
          s = "(null)";
    3bb6:	bb 2e 55 00 00       	mov    $0x552e,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c01:	a1 00 a6 00 00       	mov    0xa600,%eax
{
  ...
  freep = p;
    ...
    3c41:	5b                   	pop    %ebx
  freep = p;
    3c42:	89 15 00 a6 00 00    	mov    %edx,0xa600
}
    3c48:	5e                   	pop    %esi
    3c49:	5f                   	pop    %edi
    3c4a:	5d                   	pop    %ebp
  ...
  freep = p;
    3c7c:	89 15 00 a6 00 00    	mov    %edx,0xa600
    p->s.size += bp->s.size;
    3c82:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    3c85:	8b 43 f8             	mov    -0x8(%ebx),%eax
    3c88:	89 02                	mov    %eax,(%edx)
}
    3c8a:	5b                   	pop    %ebx
    3c8b:	5e                   	pop    %esi
    3c8c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3c9c:	8b 3d 00 a6 00 00    	mov    0xa600,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3ce9:	8b 3d 00 a6 00 00    	mov    0xa600,%edi
  ...
  return freep;
    3d17:	a1 00 a6 00 00       	mov    0xa600,%eax
    ...
    3d44:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    3d47:	a3 00 a6 00 00       	mov    %eax,0xa600
}
    ...
    base.s.ptr = freep = prevp = &base;
    3d60:	c7 05 00 a6 00 00 04 	movl   $0xa604,0xa600
    3d67:	a6 00 00 
    base.s.size = 0;
    3d6a:	bf 04 a6 00 00       	mov    $0xa604,%edi
    base.s.ptr = freep = prevp = &base;
    3d6f:	c7 05 04 a6 00 00 04 	movl   $0xa604,0xa604
    3d76:	a6 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d79:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    3d7b:	c7 05 08 a6 00 00 00 	movl   $0x0,0xa608
    3d82:	00 00 00 
    if(p->s.size >= nunits){
