...
user/_wc:     formato del fichero elf32-i386
 ...
 701:	a1 c0 0d 00 00       	mov    0xdc0,%eax
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	89 15 c0 0d 00 00    	mov    %edx,0xdc0
}
 748:	5e                   	pop    %esi
 749:	5f                   	pop    %edi
 74a:	5d                   	pop    %ebp
 ...
 779:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 77c:	89 15 c0 0d 00 00    	mov    %edx,0xdc0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 3d c0 0d 00 00    	mov    0xdc0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7e7:	73 4f                	jae    838 <malloc+0xa8>
    ...
    if(p == freep)
 7e9:	8b 3d c0 0d 00 00    	mov    0xdc0,%edi
 ...
 812:	e8 e9 fe ff ff       	call   700 <free>
  return freep;
 817:	a1 c0 0d 00 00       	mov    0xdc0,%eax
 ...
 844:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 847:	a3 c0 0d 00 00       	mov    %eax,0xdc0
}
